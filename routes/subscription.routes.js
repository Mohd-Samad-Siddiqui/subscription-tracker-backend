...
subscriptionRouter.put('/:id', (req,res) => res.send({title: 'UPDATE user subscription'}));

subscriptionRouter.get('/user/:id', (req,res) => res.send({title: 'GET user all subscription details'}));
